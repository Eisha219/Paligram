...
.preloader-logo {
    ...
    border-top: 5px solid #7c0a02;
    
}


.preloader-circle {
    border: 5px solid #21421e;
    border-top: 5px solid #21421e;
    border-radius: 50%;
    width: 250px;
    height: 250px;
...
<div class="preloaderBg" id="preloader">
    <div class="preloader-wrap">
        ...
        <span class="logo justify-content-center align-items-center">Paligram</span> </div>
