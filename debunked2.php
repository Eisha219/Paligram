...
<div class="container mt-4 jewish">
  <div class="row">
    ...
    <div class=" mt-3 mx-auto border border-start-0 border-top-0 border-bottom-0 border-dark"></div> <!-- Adjust the width as needed -->
    <!-- Right Side Content -->
    ...
    <div class="row mx-4">
      ...
      <div class="text-content">
        ...
        <h2 class="text-white">Gaza Claims</h2>
        <span class="text-dark mt-4 fw-bold">S <span>croll</span></span>
        </div>
      <p class="mb-2">In the 4th century, as the Roman Empire transitioned to Christianity, Palestine became a center of Christianity,
         ...
         the semi-independent Tulunids and the Ikhshidids; the Fatimids; and the Seljuks. In 1099,
          the Crusaders established the Kingdom of Jerusalem in Palestine, which the Ayyubid Sultanate
           reconquered in 1187. Following the invasion of the Mongol Empire in the late 1250s, the Egyptian
           <div class="col-lg-6 mx-3 my-3 " >
           <img src="./Assets/images/banner-1.jpg" alt="" class="" style="height:300px">
           </div>
    
            Mamluks reunified Palestine under its control before the Ottoman Empire conquered the region in 1516 and ruled it as Ottoman Syria largely undisrupted through to the 20th century.</p>
