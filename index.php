...
<div class="container  banner-section">
  ...
  <button class="carousel-control-prev " type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
    <span class="carousel-control  " aria-hidden="true"><i class="fa fa-chevron-left"></i></span>
    <span class="visually-hidden ">Previous</span>
  </button>
  <button class="carousel-control-next  " type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    <span class="carousel-control" aria-hidden="true"><i class="fa fa-chevron-right"></i></span>
...
<div class="container mt-4 ">
    <div class="row justify-content-center " >
        ...
        <h2 class="text-center card-content "><a href="numbers.php" class="section-subtitle">not just number</a></h2>
        </div>   
        <div class=" card-design mb-3" >
        <img src="./Assets/images/Home/Redbox3.jpg" class="img-fluid h-100 card-img" alt="Banner Image">
        <h2 class="text-center card-content"><a href="debunked.php" class="section-subtitle">Debunked</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/Black1.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="jewish.php" class="section-subtitle">Jewish Voices & Testimonials</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/Black2.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="currentevents.php" class="section-subtitle">Current Events</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/Black3.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="boycott.php" class="section-subtitle">Boycott Divestment Sanctions</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/greenbox1.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="essentials.php" class="section-subtitle">Law Essentials</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/greenbox2.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="recommended.php" class="section-subtitle">Recommended Reading</a></h2>
        </div>   
        <div class=" card-design mb-3">
        <img src="./Assets/images/Home/greenbox3.jpg" class="" alt="Banner Image">
        <h2 class="text-center card-content"><a href="stats.php" class="section-subtitle">Stats</a></h2>
        </div>   
    </div>  
</div>
</section>
