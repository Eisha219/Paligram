...
<div class="container  banner-section">
  <div class="row gx-3 gx-sm-0">
    <div class="col-lg-4 banner-image p-0 p-lg-0 ">
...
<!-- timeline pages section  -->
<div class="container timeline">
  <div class="row mx-auto">
  <div class="col-md-6">
        <div class="timeline-container">
          <img src="./Assets/images/History/timelines.png" alt="Timeline Image" class="timeline-image">
          <!-- Dates -->
          <div class="date-label date1">1897 <span class="mx-5 first-date text-center ">first world zionist congress and the founding of the zionist orgnization</span></div>
          <div class="date-label date2">1916 <span class="mx-5">Sykes-picot Agreement</span></div>
          <div class="date-label date3">1917<span class="mx-5">Balfour Declaration</span></div>
          <div class="date-label date4">1922<span class="mx-5">British mandate of palestine </span></div>
          <div class="date-label date5">1936<span class="mx-5">Start of palestine revolt against british rule</span></div>
          <div class="date-label date6">1948<span class="mx-5">The Nakba israil is created</span></div>
          <div class="date-label date7">1967<span class="mx-5">The six day war</span></div>
          <div class="date-label date8">1987<span class="mx-5">The first intifada</span></div>
          <div class="date-label date9">1993-5<span class="mx-5">olso agreement</span></div>
          <div class="date-label date10">2000<span class="mx-5">the second intifada</span></div>
        </div>
      </div>
    <div class="col-md-6 ">
      <div class="history-bg ">
      <div class="text-content scroll">
      <p class="mb-2">In the 4th century, as the Roman Empire transitioned to Christianity, Palestine became a center of Christianity, attracting pilgrims, monks and scholars. Following the Muslim conquest of the Levant in 636–641, several Muslim ruling dynasties succeeded each other as they wrestled control of Palestine: the Rashiduns; the Umayyads, who built the Dome of the Rock and the al-Aqsa Mosque in Jerusalem; the Abbasids; the semi-independent Tulunids and the Ikhshidids; the Fatimids; and the Seljuks. In 1099, the Crusaders established the Kingdom of Jerusalem in Palestine, which the Ayyubid Sultanate reconquered in 1187. Following the invasion of the Mongol Empire in the late 1250s, the Egyptian Mamluks reunified Palestine under its control before the Ottoman Empire conquered the region in 1516 and ruled it as Ottoman Syria largely undisrupted through to the 20th century.</p>
