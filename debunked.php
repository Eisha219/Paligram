...
<div class="container mt-4">
  ...
  <div class="col-lg-6 mt-3">
    <div class="card position-relative zoom-shadow">
      ...
      <div class="card-img-overlay d-flex mt-3 justify-content-center">
        <h5 class="card-title text-dark">7th of October</h5>
      </div>
      <div>
  ...
  <div class="col-lg-6 mt-3">
    <div class="card position-relative zoom-shadow">
      ...
      <div class="card-img-overlay d-flex mt-3 justify-content-center">
        <h5 class="card-title text-dark">Palestine was an empty land</h5>
      </div>
      <div>
        <img src="./Assets/images/banner-1.jpg" alt="">
      </div>
...
<a href="debunked2" class="main-btn ">Read More</a>
</div>
    </div>
  </div>
</div>
